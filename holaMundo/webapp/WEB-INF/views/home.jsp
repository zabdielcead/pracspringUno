			...
			<c:forEach items="${peliculas }" var="pelicula">
	          <div class="col-xs-12 col-sm-6 col-md-3">
	            ...
	            <h4>
	              ...
	              <span class="label label-default">${pelicula.imagen}</span>
	            </h4>   
	            <!--       
	            	<p><a class="btn btn-sm btn-primary" href="detail/${pelicula.id}/${fechaBusqueda}" role="button">Consulta Horarios &raquo;</a></p>
	             -->
	                <p><a class="btn btn-sm btn-primary" href="detailReqParam?idMovie=${pelicula.id}&fecha=${fechaBusqueda}" role="button">Consulta Horarios &raquo;</a></p>
	          </div>
			</c:forEach>
