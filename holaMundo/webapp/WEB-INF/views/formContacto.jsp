      ...
      <div class="container theme-showcase" role="main">
         ...
         <form:form class="form-horizontal" method="post" action="${ urlRoot }contacto" modelAttribute="instanciaContacto">
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <form:input type="text" class="form-control" path="nombre" id="nombre" name="nombre" placeholder="Nombre" required="required" />
               </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <form:select path="generos" id="generos" name="generos" multiple="multiple" class="form-control" items="${ generos }"/>
               </div>
            </div>
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <form:textarea class="form-control" path="comentarios" name="comentarios" id="comentarios" rows="5"></form:textarea>
               </div>
            </div>
